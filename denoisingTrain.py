...
def apply_augmentations_pair(
    ...
    *,
    ...
    max_time_shift_frac: float = 0.15,  # ±15% der Breite
    ...
    noise_std: float = 0.05,            # 2.5% in [0,1]
...
def tile_infer_full_simple(
    ...
    assert H == 512, f"Erwarte Höhe 512, bekam {H}"
...
def train(model: nn.Module,
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        # ---------- Bestes Modell sichern + Triplets ----------
