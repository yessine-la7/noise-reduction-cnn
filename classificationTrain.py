...
# ################ custom split MIL mit seed und alle visualization
# import os
# DETERMINISTIC = True  # <- False für schnellere, nicht exakt reproduzierbare Runs
# if DETERMINISTIC:
#     # Muss gesetzt werden, bevor ein CUDA-Kontext entsteht
...
#     criterion = nn.CrossEntropyLoss()
#     optimizer = Adam(model.parameters(), lr=lr)  # Keine L2-Regularisierung mehr
#     scheduler = lr_scheduler.StepLR(optimizer, step_size=5, gamma=0.1)
#     early_stopper = EarlyStopping(patience=patience, min_delta=None, verbose=True,
#                                   adapt_start_epoch=adapt_start_epoch)
...
#     # Für Determinismus: Single-process Loading
#     num_workers = 0 if DETERMINISTIC else 4
...
#     # === MIL-Tiling Visualisierung (vor dem Training) ===
#     visualize_mil_tiling(train_loader.dataset, results_dir, num_files=3, subdir="tiling_train", tag_prefix="Tiling_Train")
#     visualize_mil_tiling(val_loader.dataset,   results_dir, num_files=3, subdir="tiling_val",   tag_prefix="Tiling_Val")
